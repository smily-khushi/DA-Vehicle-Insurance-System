...
const HeroSection = () => {
    ...
    const animClass = visible ? 'animate-up' : 'opacity-0';
            ...
            <Container className="position-relative py-5">
                <Row className="align-items-center g-5">
                    <Col lg={7} className="text-center text-lg-start mb-5 mb-lg-0">
                        <Badge bg="rgba(99, 102, 241, 0.1)" className={`text-primary px-3 py-2 rounded-pill mb-4 border border-primary border-opacity-25 ${animClass}`} style={{ animationDelay: '0.2s' }}>
                            <FaStar className="me-2" /> Top Rated Vehicle Insurance 2024
                        </Badge>

                        <h1 className={`display-3 fw-bold mb-4 lh-sm text-white ${animClass}`} style={{ animationDelay: '0.3s' }}>
                            Your Journey, <span className="text-gradient">Fully Protected</span>
                        </h1>

                        <p className={`lead mb-5 text-secondary fs-4 ${animClass}`} style={{ animationDelay: '0.4s' }}>
                            Drive with confidence. Get customized vehicle insurance plans with
                            comprehensive coverage and 24/7 priority support.
                        </p>

                        <div className={`d-flex flex-column flex-sm-row gap-3 justify-content-center justify-content-lg-start ${animClass}`} style={{ animationDelay: '0.5s' }}>
                            <Button
                                size="lg"
                                variant="primary"
                        ...
                        <div className={`mt-5 d-flex gap-4 justify-content-center justify-content-lg-start ${animClass}`} style={{ animationDelay: '0.6s' }}>
                    ...
                    <Col lg={5} className="hero-image-container d-none d-lg-block">
                        <div className={animClass} style={{ animationDelay: '0.7s' }}>
